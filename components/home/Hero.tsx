...
const text = "Öreg Tölgy Kastély-fogadó";
  ...
  return (
    ...
    >
      ...
      <motion.div className="overlay">
        ...
        >
          Köszöntelek az Öreg Tölgy Kastély-Fogadóban. Nagy örömömre szolgál,
          hogy itt vagy, kérlek hadd tartsak neked egy rövid virtuális
          terepszemlét.
        </motion.span>
      </motion.div>
    </motion.section>
