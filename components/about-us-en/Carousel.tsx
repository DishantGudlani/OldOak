    ...
    <div className="embla team-carousel opacity-0">
      <div className="embla__viewport" ref={emblaRef}>
        <div className="embla__container">
          <div className="relative embla__slide embla__class-names carouselOverlay-en">
            <Image
          ...
          <div className="relative embla__slide embla__class-names carouselOverlay-1-en">
            <Image
          ...
          <div className="relative embla__slide embla__class-names carouselOverlay-2-en">
            <Image
          ...
          <div className="relative embla__slide embla__class-names carouselOverlay-3-en">
            <Image
              className="embla__slide__img"
              src={team4}
              alt="Your alt text"
