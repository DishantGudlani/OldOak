...
const text = "The history of the castle";
    ...
    >
      ...
      >
        <Image
          ...
          alt="leaf"
        ></Image>
        The castle was built around the 1870s, when the wood was already approx.
      ...
      <p className=" pt-10 mt-28 text-base px-4 lg:px-20 opacity-0 backdrop-blur-md text-[--primary] font-semibold history-info">
        ...
        <span className="text-xs lg:text-sm text-[#328177]]">
          The name of the castle was given by his father. Who imagined a
          boarding house with horses for yourself. He got involved with a
          friend, saw the tree, immediately he fell in love with the place and
          said he would make his dream come true here. The his father was a
          horse man. He&apos;s an antiques dealer and that&apos;s where he got
          all this from stuff, yes. which Oliver had already collected for him.
