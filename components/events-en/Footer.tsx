...
export const Footer = () => {
  ...
  return (
    <div className=" h-40 w-full pt-20">
      <div className="flex flex-col items-center justify-center lg:px-32 px-4">
        ...
        <div className="w-full flex items-center justify-center backdrop-blur-md">
          <div className="flex lg:hidden w-full flex-col gap-1 items-center">
          ...
          <div className="w-full hidden lg:flex items-center justify-center backdrop-blur-md">
